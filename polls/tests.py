...
class QuestionModelTests(TestCase):
    ...
    def test_recently_published_with_future_question(self):
        """
        recently_published() returns False for questions whose
    ...
    def test_recently_published_with_old_question(self):
        """
        Returns false for questions whose pubdate is older than one day
        """
    ...
    def test_recently_published_with_recent_question(self):
        """
        Was published recently returns true for questions whose pubdate is
         within the last day
        """
...
class QuestionDetailViewTests(TestCase):
    def test_future_question(self):
        """
        The detail view of a question with a pubdate in the future returns
        a 404 not found
        """

        future_question = create_question(question_text="Am from the future", days=6)
    ...
    def test_past_question(self):
        """
        The detail view of a question with a past pubdate displays the question's
        text
        """
